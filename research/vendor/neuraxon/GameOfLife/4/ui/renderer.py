# Neuraxon Game of Life v.4.0 ui renderer (Research Version):(Multi - Neuraxon 2.0 Compliant) Internal version 135
# Based on the Papers:
...
class Renderer:
    ...
    def __init__(self, world: 'World', textures: Dict[str, Optional[str]], textures_alpha: float):
        pygame.init()
        pygame.display.set_caption("Neuraxon Game of Life v 4.0 (Research Version) - By David Vivancos & Dr Jose Sanchez for Qubic Science")
