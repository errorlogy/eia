...
def run_config_screen() -> Optional[Dict[str, Any]]:
    ...
    pygame.display.set_caption("Neuraxon Game Of Life v 2.5 (Research Version) By David Vivancos & Dr Jose Sanchez for Qubic Science - Configuration")
    ...
    while running:
        ...
        title_surf = title_font.render("Neuraxon Game Of Life 2.5 (Research Version) - World Configuration", True, (235, 235, 240))
