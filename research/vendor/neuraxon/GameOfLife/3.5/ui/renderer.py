# Neuraxon Game of Life 3.5 UI Renderer (Neuraxon 2.0 Compliant) Internal version 125
# Based on the Papers:
...
class Renderer:
    ...
    def __init__(self, world: 'World', textures: Dict[str, Optional[str]], textures_alpha: float):
        pygame.init()
        pygame.display.set_caption("Neuraxon Game of Life v 3.5 (Research Version) - By David Vivancos & Dr Jose Sanchez for Qubic Science")
