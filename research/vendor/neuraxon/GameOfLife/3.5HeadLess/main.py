# Neuraxon Game of Life v.3.5 (Research Version): For Neuraxon 2.0 Headless Mode (No Game GUI)
# Used to capture the dataset: https://huggingface.co/datasets/DavidVivancos/Neuraxon2LifeTS
