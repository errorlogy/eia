# Neuraxon Game of Life v.5.05 menus (Research Version):(Multi - Neuraxon 2.0 Compliant) Internal version 190
# Based on the Papers:
...
def run_config_screen() -> Optional[Dict[str, Any]]:
    ...
    pygame.display.set_caption("Neuraxon Game Of Life v 5.0 (Research Version) By David Vivancos & Dr Jose Sanchez for Qubic Science - Configuration")
    ...
    while running:
        ...
        title_surf = title_font.render("Neuraxon Game Of Life 5.0 (Research Version) - World Configuration", True, (235, 235, 240))
