# Neuraxon Game of Life v.5.10 (Research Version):(Multi - Neuraxon 2.0 Compliant) Internal version 196
# Based on the Papers:
...
from architecture import load_architecture  # v155 — architecture parameterisation

if __name__ == "__main__":
    # v155 — load architecture FIRST so anything that reads parameters
    # during startup (config_screen, game_loop) sees the overrides.
    load_architecture(verbose=True)
