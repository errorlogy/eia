#!/usr/bin/env python3
"""T-BRAIN-03 runner — Brain-AI OMEGA_t → shadow multitick bridge harness.
...
from t_brain_03_shadow_bridge import (  # noqa: E402
    ARTIFACT_JSON,
    ARTIFACT_MD,
    artifact_sha256,
    build_t_brain_03_payload,
    render_t_brain_03_markdown,
)
...
def main() -> int:
    ...
    payload = build_t_brain_03_payload(
        seed=seed,
        generated=today,
    ...
    ARTIFACT_MD.write_text(render_t_brain_03_markdown(payload), encoding="utf-8")

    summary = {
        k: v
        for k, v in payload.items()
        if k not in ("arms", "native_shadow")
    }
