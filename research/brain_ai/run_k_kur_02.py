#!/usr/bin/env python3
"""K-KUR-02 runner — paired do(O) scramble decorrelation."""
...
from k_kur_02_scramble_decorrelation import (  # noqa: E402
    ARTIFACT_JSON,
    ARTIFACT_MD,
    artifact_sha256,
    build_k_kur_02_payload,
    render_k_kur_02_markdown,
)
...
def main() -> int:
    ...
    payload = build_k_kur_02_payload(
        seed=seed, generated=today, session_ticks=session_ticks
    )
    ...
    ARTIFACT_MD.write_text(render_k_kur_02_markdown(payload), encoding="utf-8")
