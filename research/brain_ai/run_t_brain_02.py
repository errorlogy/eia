#!/usr/bin/env python3
"""T-BRAIN-02 runner — OMEGA_t vs behavioral proxy correlation harness.
...
from t_brain_02_omega_behavior import (  # noqa: E402
    ARTIFACT_JSON,
    ARTIFACT_MD,
    artifact_sha256,
    build_t_brain_02_payload,
    render_t_brain_02_markdown,
)
...
def main() -> int:
    ...
    payload = build_t_brain_02_payload(
        seed=seed,
        generated=today,
    ...
    ARTIFACT_MD.write_text(render_t_brain_02_markdown(payload), encoding="utf-8")
