#!/usr/bin/env python3
"""T-BRAIN-04 runner — longitudinal shadow carryover harness.
...
from t_brain_04_longitudinal_carryover import (  # noqa: E402
    ARTIFACT_JSON,
    ARTIFACT_MD,
    artifact_sha256,
    build_t_brain_04_payload,
    render_t_brain_04_markdown,
)
...
def main() -> int:
    ...
    payload = build_t_brain_04_payload(
        seed=seed,
        generated=today,
    ...
    ARTIFACT_MD.write_text(render_t_brain_04_markdown(payload), encoding="utf-8")
