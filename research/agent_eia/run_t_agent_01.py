#!/usr/bin/env python3
"""T-AGENT-01 runner — LLM + EIA harness at X^trigger=0.
...
from t_agent_01_llm_eia import (  # noqa: E402
    ARTIFACT_JSON,
    ARTIFACT_MD,
    artifact_sha256,
    build_t_agent_01_payload,
    render_t_agent_01_markdown,
)
...
def main() -> int:
    ...
    payload = build_t_agent_01_payload(
        seed=seed,
        generated=today,
    ...
    ARTIFACT_MD.write_text(render_t_agent_01_markdown(payload), encoding="utf-8")
