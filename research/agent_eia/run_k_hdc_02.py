#!/usr/bin/env python3
"""K-HDC-02 runner — HDC carryover across 2+ session ticks."""
...
from k_hdc_02_carryover import (  # noqa: E402
    ARTIFACT_JSON,
    ARTIFACT_MD,
    artifact_sha256,
    build_k_hdc_02_payload,
    render_k_hdc_02_markdown,
)
...
def main() -> int:
    ...
    payload = build_k_hdc_02_payload(
    ...
    ARTIFACT_MD.write_text(render_k_hdc_02_markdown(payload), encoding="utf-8")
