#!/usr/bin/env python3
"""T-AGENT-03 runner — Brain-AI OMEGA_t bridged into Agent-EIA harness.
...
from t_agent_03_brain_agent_bridge import (  # noqa: E402
    ARTIFACT_JSON,
    ARTIFACT_MD,
    artifact_sha256,
    build_t_agent_03_payload,
    render_t_agent_03_markdown,
)
...
def main() -> int:
    ...
    payload = build_t_agent_03_payload(
        seed=seed,
        generated=today,
    ...
    ARTIFACT_MD.write_text(render_t_agent_03_markdown(payload), encoding="utf-8")

    summary = {
        k: v
        for k, v in payload.items()
        if k not in ("arms_full",)
    }
