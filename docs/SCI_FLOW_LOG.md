...
## Entry 077 — 2026-09-11 — Merge Brain-AI + Agent-EIA strand to main

**Session:** Merge `research/brain-ai-connectome` → `main` — full M-BRAIN-AI (T-BRAIN-01..06) + M-AGENT-EIA (T-AGENT-01..03) harnesses, figures, tests, sci-flow docs; **vendor excluded** (~953k LOC `research/vendor/graphitti` + neuraxon snapshot).
**Branch:** `main`
**Claim level:** **C2** unchanged. **No AGI\* claim.** `claim_allowed=false`
...
| Loop | Summary |
|------|---------|
| S1 | `git merge origin/research/brain-ai-connectome` — README conflict resolved (DOI + preprint preserved) |
| S2 | `research/vendor/` removed from merge (1865 files; graphitti witness CI remains on research branch only) |
| S3 | README updated — brain_ai + agent_eia pointers on main |
| S4 | `pytest tests/test_t_brain_* tests/test_t_agent_* -q` |
| S5 | Push `origin/main` |
...
| Item | Value |
|------|-------|
| Milestones | **M-BRAIN-AI** + **M-AGENT-EIA** |
| Harnesses | T-BRAIN-01..06 · T-AGENT-01..03 |
| Vendor | **excluded** |
| `claim_allowed` | **false** |

### Next

Optional FlyWire offline export; scale T-AGENT-02 paired worlds; no C raise.
